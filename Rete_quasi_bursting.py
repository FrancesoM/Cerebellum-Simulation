...
p_rate = 6.0/N_Mossy #perchè la frequenza di stimolazione è 6Hz
#------------------------------------------------------
...
nest.SetStatus(neu_Golgi, {'a': 0.02,'b': 0.19,'c': -45.0, 'd': 0.05,'V_th': V_th_Golgi,'I_e':6.0}) # no sparo 5.64 si a 5.65
nest.SetStatus(neu_Granular, {'a': 0.2,'b': 0.023,'c': -70.0, 'd': 2.0,'V_th': V_th_Granular, 'I_e':15.8}) #,'I_e':50.0
