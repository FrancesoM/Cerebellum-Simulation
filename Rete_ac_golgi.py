...
p_rate = 10.0*N_Glomeruli #perchè la frequenza di stimolazione è 6Hz
#------------------------------------------------------
...
# Neuroni esterni
mossy_signal = nest.Create('ac_generator',N_Mossy,{'amplitude': 30.0, 'frequency': 2.0})
mossy_noise = nest.Create('poisson_generator',N_Mossy,{'rate': p_rate}) #il p-rate va bene che sia 6, da controllare (da variare nel range)
...
nest.Connect(mossy_signal,neu_Golgi)
nest.Connect(mossy_noise,neu_Glomeruli)
